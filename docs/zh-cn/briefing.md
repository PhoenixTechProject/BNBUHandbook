...
在选课期间，以下平台可为您提供课程信息与评价参考：

### 咋样？（zayang.icu）

[咋样？](https://zayang.icu/) 是一个校园评价平台，专注于课程与导师的真实评价。

* **功能特点**：
  * 搜索课程与导师，查看真实评分与评价
  * 收录 766 位导师、1,486 门课程
  * 提供客观数据，来源于 BNBU 官方目录
* **使用方式**：
  * 访问 [zayang.icu](https://zayang.icu/)
  * 登录后可解锁全部评价、发表评论、参与社区互动

### CourseDB（mis.bnbu.moe）

[CourseDB](https://mis.bnbu.moe/) 是一个综合课程信息平台，提供全面的课程数据与实用工具。

* **功能特点**：
  * 浏览 1.8k 课程、查看 323 条评价、了解 869 位讲师
  * 提供 35 个专业手册
  * 实用工具：课程规划器、课表生成器、GPA 计算器、教室占用查询
* **使用方式**：
  * 访问 [mis.bnbu.moe](https://mis.bnbu.moe/)
  * 可直接浏览课程、搜索信息，无需登录

::: tip 选课建议
两个平台各有侧重：**咋样？** 侧重学生评价与社区互动，**CourseDB** 侧重课程数据与规划工具。建议结合使用，获取更全面的选课参考。
:::
