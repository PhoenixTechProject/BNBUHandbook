...
## 学生优惠票
需要使用学生优惠票，请在微信公众号惠通学子公众号注册，选定站点，并携带学生证（Booklet）于开放时间前往 T4 师生活动中心自助机更新信息。  

更新后于12306学生优惠界面填写一致的站点信息，提交申请，系统会在几分钟内自动通过审核。
...
3. 类似手机刷码乘地铁，无需购票；只需打开铁路e卡通乘车码并刷码进出站（部分站点闸机出现适配问题时请使用人工通道白色机器）。入闸后系统会自动分配座位，请于手机/闸机屏幕上查看。
