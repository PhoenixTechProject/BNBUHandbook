...
互動式地圖入口：<https://u-map.haotian22.top>
...
揀課嗰陣，以下平台可以幫你搵到課程資訊同評價參考：

### 咋樣？（zayang.icu）

[咋樣？](https://zayang.icu/) 係一個校園評價平台，專注於課程同導師嘅真實評價。

* **功能特點**：
  * 搜尋課程同導師，睇真實評分同評價
  * 收錄 766 位導師、1,486 門課程
  * 提供客觀數據，來源於 BNBU 官方目錄
* **使用方式**：
  * 訪問 [zayang.icu](https://zayang.icu/)
  * 登入後可以解鎖全部評價、發表評論、參與社區互動

### CourseDB（mis.bnbu.moe）

[CourseDB](https://mis.bnbu.moe/) 係一個綜合課程資訊平台，提供全面嘅課程數據同實用工具。

* **功能特點**：
  * 瀏覽 1.8k 課程、查看 323 條評價、了解 869 位講師
  * 提供 35 個專業手冊
  * 實用工具：課程規劃器、課表生成器、GPA 計算器、教室佔用查詢
* **使用方式**：
  * 訪問 [mis.bnbu.moe](https://mis.bnbu.moe/)
  * 可以直接瀏覽課程、搜尋資訊，唔使登入

::: tip 揀課建議
兩個平台各有側重：**咋樣？** 側重學生評價同社區互動，**CourseDB** 側重課程數據同規劃工具。建議結合使用，攞到更全面嘅揀課參考。
:::
